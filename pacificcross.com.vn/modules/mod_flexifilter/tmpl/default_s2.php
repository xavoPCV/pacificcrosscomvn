...
<script>
	...
	jQuery( document ).ready(function($) {
        ...
        $("#moduleFCform_<?php echo $module->id ?>").attr('action','<?php echo juri::base(); ?>vi/tra-cứu-bệnh-viện.html');
...
<a href="<?php echo $directBillingLink ?>"><button title="<?php echo $directBillingText?>">Tải</button></a>
<?php
// FORM in slider
