...
class EasyBlogBlockHandlerYahoo extends EasyBlogBlockHandlerAbstract
{
    public $icon = 'fa fa-yahoo';
    ...
    public function meta()
    {
        ...
        $meta->player = $template->output('site/composer/blocks/handlers/yahoo/player');
        $meta->wrapper = $template->output('site/composer/blocks/handlers/yahoo/wrapper');
    ...
    public function getHtml($block, $textOnly = false)
    {
        ...
        $contents = $template->output('site/blogs/blocks/yahoo');
