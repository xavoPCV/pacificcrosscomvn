...
class EasyBlogSocialButtonPocket extends EasyBlogSocialButton
{
	public $type 	= 'pocket';
	...
	public function html()
	{
		...
		$output = $theme->output('site/socialbuttons/pocket');
		return $output;
	}
	...
	{
		if ($this->frontpage && !$this->config->get('main_pocket_button_frontpage', $this->config->get('social_show_frontpage'))) {
			return false;
		}
