...
class EasyBlogSocialButtonLinkedin extends EasyBlogSocialButton
{
	...
	public function html()
	{
		...
		$output = $theme->output('site/socialbuttons/linkedin');
	...
	{
		// If this is a frontpage, ensure that show in frontpage is enabled
		if ($this->frontpage && !$this->config->get('main_linkedin_button_frontpage', $this->config->get('social_show_frontpage'))) {
			return false;
		}
