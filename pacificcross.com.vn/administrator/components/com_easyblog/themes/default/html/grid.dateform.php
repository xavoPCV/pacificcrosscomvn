...
<div id="echo empty( $id ) ? $name : $id;" name="<?php echo $name; ?>" <?php echo $attributes; ?> data-date-form>
	...
	<input type="text" class="input" name="date-day" value="<?php echo $day; ?>" placeholder="DD" data-date-day data-date-default="<?php echo $day; ?>" />
	...
	<input type="text" class="input" name="date-year" value="<?php echo $year; ?>" placeholder="YYYY" data-date-year data-date-default="<?php echo $year; ?>" />
