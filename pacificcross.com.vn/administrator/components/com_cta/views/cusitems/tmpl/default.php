...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cta&view=cusitems'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th>
					<div align="left"><?php echo JHtml::_('grid.sort',  'Title', 'a.title', $listDirn, $listOrder); ?></div>
				</th>
				<th>
					<div align="left"><?php echo JHtml::_('grid.sort',  'Type', 'a.file_type', $listDirn, $listOrder); ?></div>
				</th>
				<th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_cta&task=cusitem.edit&id='.(int)$item->id); ?>"><?php echo $item->title;?></a>
				</td>
				<td>
