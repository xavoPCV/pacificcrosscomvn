        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="wordList">
                ...
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_WORDS_PRONOUNCIATION', 'a.pronounciation', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_WORDS_CATEGORY', 'a.category', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_WORDS_DEFINITION', 'a.definition', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_WORDS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
                    </th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_GNOSIS_WORDS_CREATION_DATE', 'a.creation_date', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_GNOSIS_WORDS_MODIFIED_DATE', 'a.modified_date', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_GNOSIS_WORDS_TAGS', 'a.tags', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_GNOSIS_WORDS_SOURCE', 'a.source', $listDirn, $listOrder); ?>
				</th>
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_gnosis&task=word.edit&id=' . (int)$item->id); ?>">
                                ...
                                $data = array();
                                    ...
                                    $query
                                        ->select('cat.category_name ')
                                         ->join ( 'LEFT', '`#__gnosis` as gn on gn.category = cat.id  ')  
                                        ->from(' `#__gnosis_category` as cat')
