 ...
 */
class GnosisViewWords extends JViewLegacy
{
    protected $items;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_GNOSIS_TITLE_WORDS'), 'words.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_gnosis&view=words');
        ...
        $form = JForm::getInstance('com_gnosis.word', 'word');
