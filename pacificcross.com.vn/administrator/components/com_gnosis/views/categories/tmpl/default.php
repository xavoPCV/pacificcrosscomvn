...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_gnosis&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_gnosis&view=categories'); ?>" method="post" name="adminForm"
      id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="categoryList">
                ...
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_CATEGORIES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_GNOSIS_CATEGORIES_CATEGORY', 'a.category', $listDirn, $listOrder); ?>
                    </th>
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_gnosis&task=category.edit&id=' . (int)$item->id); ?>">
