 ...
 */
class GnosisViewCategories extends JViewLegacy
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        GnosisHelper::addSubmenu('categories');
    ...
    protected function addToolbar()
    {
        ...
        $canDo = GnosisHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_GNOSIS_TITLE_categories'), 'categories.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_gnosis');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_gnosis&view=categories');
    ...
    protected function getSortFields()
    {
        return array(
            ...
            'a.created_by' => JText::_('COM_GNOSIS_CATEGORIES_CREATED_BY'),
            'a.category_name' => JText::_('COM_GNOSIS_CATEGORIES_CATEGORY'),
            'a.description' => JText::_('COM_GNOSIS_CATEGORIES_DESCRIPTION'),
