 ...
 * word Table class
 */
class GnosisTableword extends JTable
{
	/**
    ...
    public function __construct(&$db)
    {
        ...
        parent::__construct('#__gnosis', 'id', $db);
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state', 'com_gnosis.word.' . $array['id']) && $array['state'] == 1)) {
            $array['state'] = 0;
        }
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_gnosis.word.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_gnosis', 'word');
            $default_actions = JFactory::getACL()->getAssetRules('com_gnosis.word.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_gnosis.word.' . (int)$this->$k;
    }
    ...
    protected function _getAssetParentId($table = null, $id = null)
    {
        ...
        $assetParent->loadByName('com_gnosis');
