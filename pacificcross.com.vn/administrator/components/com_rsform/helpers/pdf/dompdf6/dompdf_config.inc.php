 ...
 */
def("DOMPDF_DEFAULT_PAPER_SIZE", RSFormProHelper::getConfig('pdf.paper', 'a4'));
def("DOMPDF_DEFAULT_PAPER_ORIENTATION", RSFormProHelper::getConfig('pdf.orientation', 'portrait'));
