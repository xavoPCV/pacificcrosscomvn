...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.24</h2>
		<ul class="version-history">
			<li><span class="version-fixed">Fix</span> When editing a submission in the frontend the Birthday field would not validate in some cases.</li>
		</ul>
