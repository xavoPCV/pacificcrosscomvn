...
class FaqModelfaqs extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'faq_category_id', 'a.faq_category_id',
                'faq_question', 'a.faq_question',
                'faq_answer', 'a.faq_answer',
                'faq_upvotes', 'a.faq_upvotes',
                'faq_downvotes', 'a.faq_downvotes',
                'faq_learningcenter', 'a.faq_learningcenter',
                'faq_date', 'a.faq_date',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.faq_question', 'asc');
    }
    ...
    protected function getListQuery() {
		...
		$query->select('faq_category_id.title AS faq_category_id');
