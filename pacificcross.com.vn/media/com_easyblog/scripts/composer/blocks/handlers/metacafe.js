EasyBlog.module("composer/blocks/handlers/metacafe", function($) {

    var module = this;

    EasyBlog.Controller("Composer.Blocks.Handlers.Metacafe", {
        elements: [
            '[data-metacafe-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]'
        ],
        defaultOptions: $.extend({

            // Form
            "{form}": "> [data-metacafe-form]",
            "{insert}": "[data-metacafe-insert]",
            "{source}": "[data-metacafe-source]",
            "{loader}": "> [data-metacafe-loader]",

            // Error message
            "{errorMessage}": "[data-metacafe-error]",

            // TED player
            "{player}": "iframe",

            // Template wrapper.
            "{wrapper}": "[data-metacafe-wrapper]"
        ...
        return {
            ...
            isUrlValid: function(url) {
                ...
                var regex = /^http:\/\/www\.metacafe\.com\/(.*)$/;
