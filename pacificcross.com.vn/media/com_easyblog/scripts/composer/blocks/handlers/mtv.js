EasyBlog.module("composer/blocks/handlers/mtv", function($) {

    var module = this;

    EasyBlog.Controller("Composer.Blocks.Handlers.Mtv", {
        elements: [
            '[data-mtv-fieldset-{url|fluid|width-fieldset|height-fieldset|width|height|update-url}]'
        ],
        defaultOptions: $.extend({

            // Form
            "{form}": "> [data-mtv-form]",
            "{insert}": "[data-mtv-insert]",
            "{source}": "[data-mtv-source]",
            "{loader}": "> [data-mtv-loader]",

            // Error message
            "{errorMessage}": "[data-mtv-error]",

            // video player
            "{player}": "iframe",

            // Template wrapper.
            "{wrapper}": "[data-mtv-wrapper]"
        ...
        return {
            ...
            isUrlValid: function(url) {
                ...
                // http://www.mtv.com/shows/teen_mom/teen-mom-season-5-you-think-you-know/1173358/video/#id=1734518
                var regex = /^(http|https):\/\/www\.mtv\.com\/(.*)$/
