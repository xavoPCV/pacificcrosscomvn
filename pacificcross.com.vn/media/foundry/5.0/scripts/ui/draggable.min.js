...
},stop:function(event,ui){var o=$(this).data("ui-draggable").options;o._zIndex&&$(ui.helper).css("zIndex",o._zIndex)}})}(jQuery)};exports(),module.resolveWith(exports)})};FD50.module("ui/draggable",moduleFactory)}();