...
},$.fn[pluginName]=function(options){return this.each(function(){var $this=$(this),data=$this.data("plugin_"+pluginName);data||($this.data("plugin_"+pluginName,data=new Plugin(this,options)),pluginInstances.push(this)),"string"==typeof options&&data[options]()})}};exports(),module.resolveWith(exports)};FD50.module("rangeslider",moduleFactory)}();