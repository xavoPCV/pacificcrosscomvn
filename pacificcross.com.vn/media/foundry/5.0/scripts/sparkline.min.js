...
this.group.removeChild(existing[0])},getShapeAt:function(el){var shapeid=el.id.substr(8);return shapeid},render:function(){this.rendered||(this.group.innerHTML=this.prerender,this.rendered=!0)}})}(jQuery)};exports(),module.resolveWith(exports)};FD50.module("sparkline",moduleFactory)}();