...
var block=(marker||{}).block;block?(self.blockText().val(marker.text.nodeValue),self.blockHtml().val($(block).clone().toHTML())):(self.blockText().val(""),self.blockHtml().val(""))},25),"{markerIndex} click":function(el){console.dir(el.data("marker"))}}})};exports(),module.resolveWith(exports)};FD50.module("mentions",moduleFactory)}();