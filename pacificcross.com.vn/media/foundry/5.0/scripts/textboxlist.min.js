...
var textField=self.textboxlist.textField().val("");setTimeout(function(){textField.focus()},150)},"{menuItem} mouseover":function(menuItem){self.menuItem().removeClass("active"),menuItem.addClass("active")},"{menuItem} mouseout":function(){self.menuItem().removeClass("active")}}})};exports(),module.resolveWith(exports)})};FD50.module("textboxlist",moduleFactory)}();