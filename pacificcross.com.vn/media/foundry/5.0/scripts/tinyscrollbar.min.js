...
},initialize()}$.tiny=$.tiny||{},$.tiny.scrollbar={options:{axis:"y",wheel:40,scroll:!0,lockscroll:!0,size:"auto",sizethumb:"auto"}},$.fn.tinyscrollbar=function(params){var options=$.extend({},$.tiny.scrollbar.options,params);return this.each(function(){$(this).data("tsb",new Scrollbar($(this),options))}),this},$.fn.tinyscrollbar_update=function(sScroll){return $(this).data("tsb").update(sScroll)}}(jQuery)};exports(),module.resolveWith(exports)};FD50.module("tinyscrollbar",moduleFactory)}();