...
<tr>
    <td style="background: #55585d; color: #fff; line-height: 1; font-size: 18px; font-weight: bold; text-align: center; padding: 30px;">
        <?php echo JText::_('COM_EASYBLOG_EMAIL_POST_REQUIRES_APPROVAL_FROM_SITE_MODERATOR'); ?>
    </td>
</tr>

<tr>
    <td style="background: #fff; padding: 40px 100px; text-align: center">
        <?php echo JText::_('COM_EASYBLOG_EMAIL_POST_REQUIRES_APPROVAL_FROM_SITE_MODERATOR_CONTENT');?>
        ...
        <div style="padding: 50px; background: #fafafa;">
            ...
            <div>
                <a href="<?php echo $blogLink;?>" style="
                    ...
                    border-radius: 3px;
                    margin: 0 5px;
                "><?php echo JText::_('COM_EASYBLOG_VIEW_POST');?></a>
            </div>
        </div>
    </td>
</tr>