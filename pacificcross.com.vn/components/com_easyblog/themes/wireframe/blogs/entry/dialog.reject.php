...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYBLOG_REJECT_POST_DIALOG_TITLE'); ?></title>
	<content>
		<p class="mt-5">
			<?php echo JText::_('COM_EASYBLOG_REJECT_POST_DIALOG_CONTENT');?>
		</p>
		...
		<form data-form-response method="post" action="<?php echo JRoute::_('index.php');?>">
			...
			<?php echo $this->html('form.action', 'posts.reject'); ?>
		</form>
	</content>
	<buttons>
		<button type="button" class="btn btn-default btn-sm" data-close-button><?php echo JText::_('COM_EASYBLOG_CANCEL_BUTTON');?></button>
		<button type="button" class="btn btn-danger btn-sm" data-submit-button><?php echo JText::_('COM_EASYBLOG_REJECT_POST_BUTTON');?></button>
	</buttons>
</dialog>
