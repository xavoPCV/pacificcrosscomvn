    ...
    <div class="eb-composer-fieldset-content">
        <div class="eb-composer-field">
            <div style="margin: 0 auto;" class="input-group">
                <input type="text" data-fs-instagram-source="" value="" class="form-control input-sm">
                <span class="input-group-btn">
                    <a data-fs-instagram-refresh="" class="btn btn-primary btn-sm" href="javascript:void(0);">
