...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-liveleak-form>
    ...
    <p class="eb-composer-placeholder-error text-error hide" data-liveleak-error>
        <?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_lIVELEAK_EMPTY'); ?>
    </p>

    <div class="input-group" style="width: 70%; margin: 0 auto;">
        <input type="text" class="form-control" type="text" value="" data-liveleak-source placeholder="<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_lIVELEAK_PLACEHOLDER_EXAMPLE', true);?>" />
        <span class="input-group-btn">
            <a href="javascript:void(0);" class="btn btn-primary" data-liveleak-insert><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_EMBED_VIDEO_BUTTON');?></a>
        </span>
    </div>
</div>
