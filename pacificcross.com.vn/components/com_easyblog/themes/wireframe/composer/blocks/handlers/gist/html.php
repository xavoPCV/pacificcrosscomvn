...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-gist-form>
    ...
    <p class="eb-composer-placeholder-error text-error hide" data-gist-error><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_GIST_EMPTY'); ?></p>
    <div class="input-group" style="width: 70%; margin: 0 auto;">
        <input type="text" class="form-control input-sm" type="text" value="" data-gist-source placeholder="<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_GIST_PLACEHOLDER', true);?>" />
        <span class="input-group-btn">
            <a href="javascript:void(0);" class="btn btn-primary btn-sm" data-gist-insert><?php echo JText::_('COM_EASYBLOG_BLOCKS_GIST_ADD_GIST');?></a>
        </span>
    </div>
</div>
