...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-instagram-form>
    ...
    <p class="eb-composer-placeholder-error text-error hide" data-instagram-error><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_INSTAGRAM_EMPTY'); ?></p>
    <div class="input-group" style="width: 70%; margin: 0 auto;">
        <input type="text" class="form-control input-sm" type="text" value="" data-instagram-source placeholder="<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_INSTAGRAM_PLACEHOLDER', true);?>" />
        <span class="input-group-btn">
            <a href="javascript:void(0);" class="btn btn-primary btn-sm" data-instagram-insert><?php echo JText::_('COM_EASYBLOG_BLOCKS_INSTAGRAM_SHARE_PHOTO_BUTTON');?></a>
        </span>
    </div>
</div>
