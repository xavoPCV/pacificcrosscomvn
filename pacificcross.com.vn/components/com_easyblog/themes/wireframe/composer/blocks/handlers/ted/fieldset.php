    ...
    <div class="eb-composer-fieldset-content">
        <div class="eb-composer-field">
            <div style="margin: 0 auto;" class="input-group">
                <input type="text" value="" class="form-control" data-ted-fieldset-url />
                <span class="input-group-btn">
                    <a href="javascript:void(0);" class="btn btn-default" data-ted-fieldset-update-url><?php echo JText::_('COM_EASYBLOG_UPDATE_BUTTON'); ?></a>
                </span>
            </div>
        </div>
    </div>
...
<div class="eb-composer-fieldset">
    ...
    <div class="eb-composer-fieldset-content">
        <div class="text-center">
            <?php echo $this->html('grid.boolean', 'youtube_fluid', true, 'youtube_fluid', 'data-ted-fieldset-fluid'); ?>
        </div>
    </div>
</div>
        ...
        <div class="eb-composer-field">
            <div class="col-lg-6 col-lg-offset-3">
                <div class="input-group">
                    <input type="text" data-ted-fieldset-width value="" class="form-control text-center" />
...
<div class="eb-composer-fieldset hide" data-ted-fieldset-height-fieldset>
    ...
    <div class="eb-composer-fieldset-content">
        <div class="eb-composer-field">
            <div class="col-lg-6 col-lg-offset-3">
                <div class="input-group">
                    <input type="text" data-ted-fieldset-height value="" class="form-control text-center" />
                    <span class="input-group-addon"><?php echo JText::_('COM_EASYBLOG_COMPOSER_PIXELS');?></span>
                </div>
            </div>
        </div>
