...
<div class="eb-composer-placeholder eb-composer-link-placeholder text-center" data-dailymotion-form>
    ...
    <p class="eb-composer-placeholder-error text-error hide" data-dailymotion-error>
        <?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_DAILYMOTION_EMPTY'); ?>
    </p>

    <div class="input-group" style="width: 70%; margin: 0 auto;">
        <input type="text" class="form-control" type="text" value="" data-dailymotion-source placeholder="<?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_DAILYMOTION_PLACEHOLDER_EXAMPLE', true);?>" />
        <span class="input-group-btn">
            <a href="javascript:void(0);" class="btn btn-primary" data-dailymotion-insert><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_EMBED_VIDEO_BUTTON');?></a>
        </span>
    </div>
</div>
