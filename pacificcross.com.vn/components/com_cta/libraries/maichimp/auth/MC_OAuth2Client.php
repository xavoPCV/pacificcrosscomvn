...
class MC_OAuth2Client extends OAuth2Client {
    ...
    public function __construct() {
		...
		$client_id = '707827837858';   //client_id from creating app in MC (see README)
        $client_secret = 'b8d8d8b8132e35f496b4d484b6a9dfa3'; //client_secret from creating app in MC  (see README)
