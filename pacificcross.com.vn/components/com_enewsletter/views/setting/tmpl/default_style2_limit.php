    ...
    savesetting111();
		...
		$( "#ajaxloadingplaceholder" ).dialog({
                ...
                $(".tabcontrol .tab3").click(function() {
                    alert('To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333.');
                    return;
                    $(".tabcontrol li").removeClass('acctive');
                      $(this).addClass('acctive');
			...
			<div id="serminar1" class="module default ui-sortable-handle" style="margin-top: 5px; margin-bottom: 20px; border: 4px solid rgb(221, 221, 221); border-radius: 3px; padding: 15px; word-wrap: break-word; text-align: center; background: rgb(255, 255, 255);">
              ...
              <a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=3" style="float: left; font-size: 20px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Estate Planning</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=5" style="float: left; font-size: 12px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Insurance</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=6" style="float: left; font-size: 21px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Investing</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=38" style="float: left; font-size: 15px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Economy</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=39" style="float: left; font-size: 18px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Family Finance</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=40" style="float: left; font-size: 12px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Lifestyle</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=41" style="float: left; font-size: 16px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Managing Your Business</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=42" style="float: left; font-size: 30px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Retirement</a><a href="https://sample6joomla.advisorproducts.com//index.php?option=com_apicontent&amp;view=apilist&amp;id=43" style="float: left; font-size: 24px; color: rgb(45, 61, 227); display: block; text-decoration: none; margin-left: 2px;" class="tag-cloud">Taxes</a>                </div>
                 ...
                 <div id="bannerf" style="width: 100%;  margin-top:30px;">
						...
						<dt>Advisor</dt>
						<dd>
                                                    <span style="color:red;" class="adsad1"  >To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333.</span><br><br><br>
<style>
	...
	$("#c").dropzone({
		...
		init: function () {
			...
			alert(errorMessage);
						...
						<dt>Poll</dt>
						<dd>
                                                    <span style="color:red;" class="adsad1"  >To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333.</span><br>		<br>
                          ...
                          $options = array(
							...
							<p>Create New Poll:</p>
                                                      ...
                                                      <p><input size="50" type="text" id="poll-questtion" value=""  placeholder="To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333."/></p>  					
...
jQuery(document).ready(function ($) {
 ...
 <button type="button" class="button-blu" id="poll-save">Save</button>
						...
						<dt>CTA</dt>
						<dd>
                                                    <span style="color:red;" class="adsad1"  >To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333.</span><br>
							<!--com_cta-->
							<ul id="ctalistasdsa">
							<?php
							if (JComponentHelper::getComponent('com_cta', true)->enabled) {
								...
								if ($videos) {
									...
									foreach ($videos as $video) {
										echo "<li><input type='radio' name='ctavideo' value='".$video['VideoId']."' > <span >".$video['Title'].'</span></li>';
									}//for
								}
								...
								if ($local_video) {
									...
									foreach (array_reverse($local_video) as $video) {
										echo "<li id='lictacustom".$video['id']."'><input type='radio' name='ctacustom' value='".$video['id']."' > <span >".$video['title'].'</span> <span class="clsdeletecta" rel="'.$video['id'].'">X</span></li>';
									}//for
								}//if
							}//if
							?>
							...
							jQuery(document).ready(function ($) {
								...
								$('.setting_widgets_area').delegate('.clsdeletecta', 'click', function(e){
                                                                    alert('To use all of the powerful new features in the email newsletter, please call Advisor Products to upgrade at (516) 333-0066 ext. 333.');return;
	...
	$("#df").dropzone({
		...
		init: function () {
			...
			alert(errorMessage);
							...
							<ul>
                                                            <li><label style="    min-width: 200px;">Title:</label> <input size="30" class="" type="text" name="textctatit" value="<?php echo $this->com_params->get('textctatit');?>" /></li>
								<li><label style="    min-width: 200px;" >Name Button:</label> <input size="30" class="" type="text" name="textbutonctatit" value="<?php echo $this->com_params->get('textbutonctatit');?>" /></li>
								
								<li><label style="    min-width: 200px;">Color Background:</label> <input size="8" class=" " type="text" name="cobactatit" value="<?php echo $this->com_params->get('cobactatit');?>" maxlength="6" /></li>
								<li><label style="    min-width: 200px;">Color Text:</label> <input size="8" class=" " type="text" name="cotectatit" value="<?php echo $this->com_params->get('cotectatit','000000');?>" maxlength="6" /></li>
								<li><label style="    min-width: 200px;">Button Background:</label> <input size="8" class=" " type="text" name="btcobactatit" value="<?php echo $this->com_params->get('btcobactatit','FFAD61');?>" maxlength="6" /></li>
								<li><label style="    min-width: 200px;">Button Color Text:</label> <input size="8" class=" " type="text" name="btcotectatit" value="<?php echo $this->com_params->get('btcotectatit');?>" maxlength="6" /></li>
			...
			alert(errorMessage);
						...
						<dd>
							...
							<ul > 
                                <li>
									<label >Firm</label>						
									<input size="30"  name="firm" value="<?php echo $this->advisorsettings->firm;?>" type="text">
								</li>	
												<li>
									<label >Email</label>						
									<input size="30" name="from_email" value="<?php echo $this->advisorsettings->from_email;?>" type="text">
								</li>	
												 <li>
									<label >URL</label>						
									<input size="30" name="url" value="<?php echo $this->advisorsettings->url;?>" type="text">
								</li>	
												<li>
									<label >Address</label>						
									<input size="30" name="address_address1" value="<?php echo $this->advisorsettings->address1;?>" type="text">
								</li>				
								<li>
									<label >Address 2</label>						
									<input size="30" name="address_address2" value="<?php echo $this->advisorsettings->address2;?>" type="text">
								</li>				
								<li>
									<label >Phone</label>	
									<input size="30" name="address_phone" value="<?php echo $this->advisorsettings->phone;?>" type="text">
								</li>				
								<li>
									<label >City</label>						
									<input size="30" name="address_city" value="<?php echo $this->advisorsettings->city;?>" type="text">
								</li>	
												<li>
									<label >State</label>						
									<input size="30" name="address_state" value="<?php echo $this->advisorsettings->state;?>" type="text">
								</li>	
								<li>
									<label >Zip</label>						
									<input size="30" name="address_zip" value="<?php echo $this->advisorsettings->zip;?>" type="text">
								</li>				
							</ul>
							<h4>Address 2</h4>
							<ul>
                                <li>
									...
									<input size="30" name="useaddress2" type="checkbox" value="1" <?php echo $this->com_params->get('useaddress2')?'checked="checked"':'';?> >
								</li>	
												<li>
									<label >Address</label>						
									<input size="30" name="address2_address1" value="<?php echo $this->advisorsettings->second_address1;?>" type="text">
								</li>				
								<li>
									<label >Address 2</label>						
									<input size="30" name="address2_address2" value="<?php echo $this->advisorsettings->second_address2;?>" type="text">
								</li>	
												<li>                                  
									<label >Phone</label>	
													   
										<input size="30" name="address2_phone" value="<?php echo $this->advisorsettings->second_phone;?>" type="text">
														
												</li>
												<li>
									<label >City</label>						
									<input size="30" name="address2_city" value="<?php echo $this->advisorsettings->second_city;?>" type="text">
								</li>	
												<li>
									<label >State</label>						
									<input size="30" name="address2_state" value="<?php echo $this->advisorsettings->second_state;?>" type="text">
								</li>	
								<li>
									<label >Zip</label>						
									<input size="30" name="address2_zip" value="<?php echo $this->advisorsettings->second_zip;?>" type="text">
								</li>	
							</ul>
                                                       
						</dd>
						<dt>Template Intro</dt>
						<dd>
...
$(document).ready(function() {
	...
	showmap($("#map-edit-img-ht").val(), $("#mapzoom-ht").val());
					...
					<div class="bigsavebutton" style="display:none;"></div>
					</form>
...
$(document).ready(function() {
    setTimeout(function(){ $('#ui-id-6 input, #ui-id-9 input ,#ui-id-12 input, #ui-id-14 input , #ui-id-18 input , #ui-id-20 input , #mapzoom-ht').prop('readonly',true); 
	$('#ui-id-6 input, #ui-id-11 input , #ui-id-20 input , #mapzoom-ht , #ctalistasdsa input').prop('disabled',true);},2000);
