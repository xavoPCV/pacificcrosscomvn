...
">
            ...
            <div id="popup3_new"  style="width:600px;height:620px;overflow-y: hidden;overflow-x: hidden;display: none;    background: white;    padding: 26px;    border: 5px #999 solid;    border-radius: 10px;     " >
              <span onclick=" $('#popup3_new').bPopup().close();" class="btclose" ><img style="width: 32px;height: 32px" src="/components/com_enewsletter/assets/images/close-window-xxl.png" /></span>
                ...
                <div class="createstep1">                   
                   ...
                   <div id="block_template" style="    text-align: left;" >
                            ...
                            <input type="radio" name="optionf" value="1" onclick="addnameauto('Your Content');$('.tgroup3').show();$('.tgroup1, .tgroup2').hide();"   /> Your Content <br>
   <input type="radio" name="optionf" value="2" onclick="addnameauto('Weekly Investment Update');$('.tgroup2,.tgroup3').hide();$('.tgroup1').show();"  />  Weekly Investment Update <br>
   <input type="radio" name="optionf" value="3" onclick="addnameauto('Weekly Financial Planning Update');$('.tgroup2,.tgroup3').hide();$('.tgroup1').show();"    /> Weekly Financial Planning Update <br>
   <input type="radio" name="optionf" value="4" onclick="addnameauto('Weekly Investment-Fin Planning Update');$('.tgroup2,.tgroup3').hide();$('.tgroup1').show();"   /> Invesment and Planning Update <br>
   <input style="float: left;" type="radio" name="optionf" value="5" onclick="addnameauto('Your Content and Investment-Fin Planning Update');$('.tgroup2').show();$('.tgroup1,.tgroup3').hide();"  /> <div style="float: left;    width: 90%;    margin-left: 4px;"  > Your Content with Weekly Investment Update and Weekly Financial Planning Update </div> <br>   
                            </div>
                  </div>
                      <br><br>
                      <span>Format <span style="color: #aaa;">( select content first )</span>:</span><br>
                    <style>
                      ...
                      <div class="divchothumtm" style="width:100%">
                            <div class="tgroup1" style="display: none;" >
                              ...
                              <div onclick="$('#sasasasa').val('weeklyupdate'); $('.chothumtm').removeClass('active');$('.aaa3').addClass('active'); " class="chothumtm aaa3" style="width:23%;margin-right: 1%;float: left;cursor: pointer;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/thum3.jpg" /> <br><div style="text-align: center;    margin-top: 10px;">Right Widgets</div>  </div>
                              
                              <div onclick="$('#sasasasa').val('weeklyupdateright'); $('.chothumtm').removeClass('active');$('.aaa5').addClass('active'); " class="chothumtm aaa5" style="width:23%;margin-right: 1%;float: left;cursor: pointer;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/thum2.jpg" /> <br><div style="text-align: center;    margin-top: 10px;">Left Widgets</div>  </div>                               
                            ...
                            <div class="tgroup2" style="display: none;" >
                                <div onclick="    $('#sasasasa').val('enewsletter'); $('.chothumtm').removeClass('active');$('.aaa1').addClass('active'); " class="chothumtm  aaa1" style="width:23%;margin-right: 1%;float: left;cursor: pointer;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/thum1.jpg" /> <br> <div style="text-align: center;    margin-top: 10px;">Right Widgets </div> </div>

                               <div onclick="     $('#sasasasa').val('enewsletter_site2'); $('.chothumtm').removeClass('active');$('.aaa2').addClass('active'); " class="chothumtm aaa2" style="width:23%;margin-right: 1%;float: left;cursor: pointer;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/thum2.jpg" /> <br> <div style="text-align: center;    margin-top: 10px;">Left Widgets </div> </div>

                             

                               <div onclick=" $('#sasasasa').val('enewsletter_threecol'); $('.chothumtm').removeClass('active');$('.aaa4').addClass('active');  " class="chothumtm aaa4" style="width:23%;margin-right: 1%;float: left;cursor: pointer;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/thum4.jpg" /> <br>  <div style="text-align: center;    margin-top: 10px;">3 Columns </div>  </div>
