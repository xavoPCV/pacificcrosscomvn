...
<script>
       <?php   if ($this->optionf == 3 || $this->optionf == 4 || $this->optionf == 5 ) { ?>         
           $( document ).ready(function() {
                   ...
                   if(!$("#settingdeclo")[0]){
                          $('<div id="settingdeclo" ><?php echo $db->escape($this->allsetting->weekly_update_newsletter); ?></div>').insertAfter($( "#cta" ));
                   }
            ...
            .ui-tabs-panel a{
              ...
              .dataTables_length {
                ...
                .ctaicon_mp4 , .ctaicon_flv{
                      background-image: url('/components/com_enewsletter/assets/images/video.png'); 
                }
                 .ctaicon_docx {
                      background-image: url('/components/com_enewsletter/assets/images/docx.png'); 
                }
                 .ctaicon_xlsx {
                      background-image: url('/components/com_enewsletter/assets/images/xlsx.png'); 
                }
                 .ctaicon_pdf  {
                      background-image: url('/components/com_enewsletter/assets/images/pdf.png'); 
                }
                .ctaicon_pptx  {
                      background-image: url('/components/com_enewsletter/assets/images/pptx.png'); 
                }
                #address {
                           min-width: 100%;
                }
                                            ...
                                            $.ajax({
                                              ...
                                              //  alert(); 
                                                 if(!$("#form1 input[type='radio']:checked").val()){
                                                        $( '#advions-content' ).append('  <a href="#" ><img src="'+data+'"  width= "100%"  > </a>'); 
                                                 }else{
                                                        $( '#advions-content' ).append('  <a member="'+$("#form1 input[name='who']:checked").val()+'" href="<?php echo juri::base(); ?>'+$("#form1 input[name='who']:checked").val()+'" ><img src="'+data+'"  width= "100%"  > </a>');                                                  
                                                 }
		...
		$('#logo-save').on('click', function (ev) {
                     if ( $("#form9 input[type='checkbox']:checked").val() == 'Yes' ){
                                    $uploadCrop.croppie('result', {
                                           ...
                                           $( '#logomail' ).append('  <img src="'+data+'"  width= "90%" style="max-width:350px;    min-width: 260px;" > ');   
                                              ajaxsave(); setTimeout(function(){ ajaxsave();},5000);
                                        }); 
                                   });
                                   $('#logomail').show();                                 
                    ...
                    $( document ).ready(function() {
                            ...
                            <?php if( JRequest::getVar('new_tem') == 1 ){ ?>
                                       ...
                                       <?php if(    $this->com_params->get('ctavideo') != ''  ){ ?>                                          
                                                ...
                                                $("#textbutonctatit").val('<?php echo $this->com_params->get('textbutonctatit'); ?>');
                       ...
                       if (e.which == 1){
                         ...
                         if ( idcont != id_edit){
                                        ...
                                        $( ".content-save" ).mouseup(function() { 
                                            ...
                                            if ($('#inputtitcus')[0]) {
                                                var titleyoucus = $('#inputtitcus').val();
                                                var titadvisorname = '<b id="titadvisorname" style="font-size: 14px;    display: block;    margin-bottom: 5px;" >'+$('#inputtitadvisorname').val()+'</b>';
                                            }else {
                                                var titleyoucus = '';
                                                var titadvisorname = '';
                                            }
                         ...
                         //   var html_cuscon =  tinyMCE.get("custom-content").getContent(); 
                            if ($.trim(cuscontit) != ''){
                                ...
                                $('#cta').prepend('<table id="articles" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="mceItemTable"><tbody><tr id="intro" bgcolor="#ECEBE0"><td style="padding: 10px 25px 10px 25px;" data-mce-style="padding: 10px 25px 10px 25px;">  <strong class="intro"> Template Intro Here.. </strong></td> </tr><tr id-cont="article_content_6" class="edit_content" id="article_6" style="" data-mce-style=""><td style="padding: 25px;" data-mce-style="padding: 25px;"> <table width="100%" class="mceItemTable"><tbody><tr><td style="padding: 0 0 0 0;  font-face: arial; font-size: 10px; text-align: justify;" valign="top" data-mce-style="padding: 0 0 0 0; width: 45%; font-face: arial; font-size: 10px; text-align: justify;"> <br> <div id="article_content_6" style="font-family: Arial; font-size: medium;" data-mce-style="font-family: Arial; font-size: medium;"> <strong style="font-size: 20px;" data-mce-style="font-size: 20px;"> <a  style="color: #000000; text-decoration: none;" >'+cuscontit+'</a></strong> <br><p>'+html_cuscon+'</p></td></tr> </tbody></table> </td></tr>  </tbody></table>')
                                 ...
                                 var check = $('#valueidartical').val();  
                            if (check != '' ){
                                  $( '#cta' ).empty().html('<span style="font-size:28px;color:red;text-align:center;" ><img style="width: 100%;height: auto;" src="/components/com_enewsletter/assets/images/clock-loading.gif" /> </span>');
                    ...
                    <div id="global-edit" class="block-3" style="display: none;"   >                         
                        ...
                        <script>
                            ...
                            $( "#global-save" ).click(function() {
                                ...
                                $("#isdatahtml > table, .weeklyupdatetable table ,.weeklyupdatetable table td ").css('background','#'+$('#backgc').val());
                                ...
                                $("#intro , .intro").css('background','#'+$('#backbargc').val());   
                                 ...
                                 if( $("#map-edit-img").val() != '' ){
                                             var  urls = "https://maps.googleapis.com/maps/api/geocode/json?address="+$("#map-edit-img").val()+"&key=AIzaSyAcBsiCXaeb4H4wZDMNtnjSRRCKP_B2D1M";
                                                $.ajax({
                                                  ...
                                                  $( "#map" ).empty();
                                                  $( "#map" ).append('  <img data="'+$("#map-edit-img").val()+'"  zoom="'+$(".single-slider" ).val()+'" src="https://maps.googleapis.com/maps/api/staticmap?center='+lat+','+lng+'&zoom='+zoom+'&size=210x210&maptype=roadmap&markers=color:blue%7Clabel:S%7C'+lat+','+lng+'&key=AIzaSyBNJIeTGgrFxcrTgo0YKZoj7Y-T7IYapS8&zoom=10"    width= "100%" > ');             
                                          });  
                                       }
                                   $('#map').show();
                                    ajaxsave();
...
<script>
    function addnameauto(a){
        ...
        if (a == 'Your Content and Investment-Fin Planning Update') {
            ...
            $('.tgroup2 .aaa6').trigger('click');
        }
        if (a == 'Three-Article Update') {
            $('.tgroup2').show();$('.tgroup1, .tgroup3').hide();
            $('.tgroup2 .aaa6').trigger('click');
            $('#popup10_open').bPopup();
              ...
              <span onclick=" $('#popup3_new').bPopup().close();" class="btclose" ><img style="width: 32px;height: 32px" src="/components/com_enewsletter/assets/images/close-window-xxl.png" /></span>
                ...
                <div class="createstep1">                   
                   ...
                   <div id="block_template" style="    text-align: left;" >
                            ...
                            <input type="radio" name="optionf" value="1" onclick="addnameauto('Your Content');"   /> Your Content <br>
   <input type="radio" name="optionf" value="2" onclick="addnameauto('Weekly Investment Update'); "  />  Weekly Investment Update <br>
   <input type="radio" name="optionf" value="3" onclick="addnameauto('Weekly Financial Planning Update'); "    /> Weekly Financial Planning Update <br>
   <input type="radio" name="optionf" value="4" onclick="addnameauto('Weekly Investment-Fin Planning Update');"   /> Weekly Investment and Planning Update <br>   
   <input style="" type="radio" name="optionf" value="5" onclick=" addnameauto('Your Content and Investment-Fin Planning Update');"  /> 
 Your Content with Weekly Investment Update and Weekly Financial Planning Update <br>    
 <input style="float: left;" type="radio" name="optionf" value="6" onclick=" addnameauto('Three-Article Update');"  />  Three-Article Update <a onclick="$('#popup10_open').bPopup();" style="cursor: pointer;" >Select Content </a><br> 
                            </div>
                  </div>
                      <br><br>
                      <span  >Format:</span><br>
	  ...
	  <?php if ( $this->optionf != 3  ) {  ?> 	<li style="width: 49%;"  ><a href="#tabs-4" class="alltab">Weekly Investment Update </a></li>  <?php }?>
       ...
       <div id="popup6_open"  style="overflow-y: auto;overflow-x: hidden;display: none;    background: white;    padding: 26px;    border: 5px #999 solid;    border-radius: 10px;    width: 600px;    height: 450px;" >
           ...
           <button  onclick="sendmail();" style="     float: right;       color: white;    background: red;    padding: 10px 15px 10px 20px;    border-radius: 10px;cursor: pointer; position: absolute;    right: 15px;    top: 150px;">Send Mail >></button>
             <span onclick=" $('#popup6_open').bPopup().close();" class="btclose" style="    top: 10px;" ><img style="width: 32px;height: 32px" src="/components/com_enewsletter/assets/images/close-window-xxl.png" /></span>
        ...
        <div id="popup11_open"  style="display: none; width:1000px;height:635px;overflow-y: auto;overflow-x: hidden;    background: #fff;    padding: 11px; border: 5px #999 solid;    border-radius: 10px;    padding-top: 30px; " >   
              ...
              <br>
              <span class="pageloadding"  style="    display: block;    width: 100%;font-size:28px;color:red;text-align:center;" ><img style="margin: 0 auto;width: 615px;height: auto;" src="/components/com_enewsletter/assets/images/clock-loading.gif" /> </span>
		...
		<div class="width-100" style="margin-bottom:15px;">
          ...
          <td class="left1" >
            ...
            ?>
                                                ...
                                                <td class="left1" style="text-align: center;" >
						<?php echo '<input disabled   id="cimag_'.$item->article_id.'" class="checkall" type="checkbox"  value="'.$item->article_id.'" name="cimag[]"  />'; ?>
						</td>
                                                
                                                <td class="left1" style="text-align: center;"  >
						<?php echo '<input disabled  id="cgetin_'.$item->article_id.'" class="checkall" type="checkbox"  value="'.$item->article_id.'" name="cgetin[]"  />'; ?>
						</td>                                               
