...
$outputorder = explode(',', $this->params->get('glorder', '0, 3, 7'));
if ($saveOrder) {
...
<form action="<?php echo JRoute::_('index.php?option=com_gnosis&view=words'); ?>" method="post" name="adminForm"
	...
	$definitionstriped = substr(strip_tags($item->definition), 0, $this->params->get('glwordsdefsize'));
							
							if ($this->params->get('glcontentplugins') == 1) {
