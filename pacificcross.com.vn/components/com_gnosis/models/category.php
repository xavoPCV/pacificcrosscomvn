 ...
 */
class GnosisModelCategory extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        if ($menuitemid) {
            ...
            $catid = $menuparams->get('cat_id'); // This shows how to get an individual parameter for use
