...
class ContactControllerContact extends JControllerForm
{
	...
	private function _sendEmail($data, $contact, $copy_email_activated)
	{
			...
			if ($copy_email_activated == true && !empty($data['contact_email_copy']))
			{
                                ...
                                $get_email = $contact->misc;
                                $get_sub = explode('{/subject}', $contact->misc);
                                $get_body = $get_sub[1];
                                $get_sub = str_replace('{subject}', '', $get_sub[0]);
				...
				$copytext.="<br><br><table width='500px' >"
                                        . "<tr><td style='text-align:right;width:80px;    background: #efefef;padding: 5px;' ><b>Name:</b></td><td    style='padding-left: 5px;'>".$data['contact_name']."</td></tr>"
                                        . "<tr><td style='text-align:right;    background: #efefef;padding: 5px;' ><b>Title:</b></td><td    style='padding-left: 5px;'>".$data['contact_subject']."</td></tr>"
                                        . "<tr><td style='text-align:right;    background: #efefef;padding: 5px;' ><b>Message:</b></td><td    style='padding-left: 5px;'>".$data['contact_message']."</td></tr>"
                                        . "</table>";
