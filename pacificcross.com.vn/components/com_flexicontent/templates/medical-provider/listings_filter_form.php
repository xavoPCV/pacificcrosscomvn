...
<div class="provider-filter bkg-white fcfilter_form_outer fcfilter_form_component">
<?php
// FORM in slider
...
<form action="<?php echo $this->action; ?>" method="post" id="adminForm" onsubmit="" class="">
