...
<?php endif; ?>
 <div class="span12">
     ...
     <h2><?php echo JText::_( 'FLEXI_CONTACT_INFO' ); ?></h2>
...
<?php if (isset($item->positions['providerMedicalServices'])) : ?>
	...
	<h2><?php echo JText::_( 'FLEXI_SPECIALITIES' ); ?></h2>
...
<h2><?php echo JText::_( 'FLEXI_OPEN_HOURS' ); ?></h2>
<div class="provider-contact-info bkg-white pall-15px">
    <p>
...
<?php if (isset($item->positions['providerLanguage'])) : ?>
	<h2><?php echo JText::_( 'FLEXI_LANGUAGE_SPOKEN' ); ?></h2>
	<div class="provider-contact-info bkg-white pall-15px">
...
<h2><?php echo JText::_( 'FLEXI_DIRECT_BILLING' ); ?></h2>
	<div class="provider-contact-info bkg-white pall-15px clearfix">
	    ...
	    <?php if (isset($item->positions['providerNote'])) : ?>
	    	<div>
	    		<br><br>
	    		<p><b><?php echo JText::_( 'FLEXI_NOTE' ); ?>:</b></p>
...
jQuery('body').addClass('medical_providers_xxx');
