...
<div id="<?php echo $form_id; ?>_filter_box" class="fc_filter_box floattext">
	...
	<fieldset class="fc_filter_set">
		...
		<?php if ($use_filters): /* BOF filter */ ?>
			...
			foreach ($filters as $filt) :
				...
				$_filter_html = 
					...
					<div class="tabbertab" id="fcform_tabset_'.$_filter_TABsetCnt.'_tab_'.($tabSetCnt++).'" >
						...
						<div class="pure-u-1 pure-u-sm-1-3 pall-15px" id="fc_filter_id_'.$filt->id.'" >'.
			...
			<?php 
			#HT - move search box to end
			
			if ( $use_search ) : /* BOF search */ ?>
			<?php
			...
			<div class="pure-u-1 pure-u-sm-2-3 pall-15px fc_filter_text_search fc_odd">
				<?php
				...
				<span class="fc_filter_html fc_text_search">
					...
					<?php if ( $msg ) : ?>
						<div class="pure-u-1">
							<span class="fc-mssg"><?php echo $msg; ?>
						</div>
					<?php endif; ?>
				</span>
		...
		?>
			...
			<div class="pure-u-1 pure-u-sm-1-3 pall-15px fc_buttons">
				<?php if ($show_search_go) : ?>
				<button class="pure-button pure-button-primary" onclick="var form=document.getElementById('<?php echo $form_id; ?>'); adminFormPrepare(form, 2); return false;" title="<?php echo JText::_( 'FLEXI_APPLY_FILTERING' ); ?>">
					<?php echo JText::_( 'FLEXI_FIND_PROVIDER' ); ?>  &nbsp;&nbsp;<i class="ion ion-search"></i>
				</button>
				<?php endif; ?>
				
				<?php if ($show_search_reset) : ?>
				<button class="pure-button" onclick="var form=document.getElementById('<?php echo $form_id; ?>'); adminFormClearFilters(form); adminFormPrepare(form, 2); return false;" title="<?php echo JText::_( 'FLEXI_REMOVE_FILTERING' ); ?>">
					</span><?php echo JText::_( 'FLEXI_RESET' ); ?>
				</button>
				<?php endif; ?>
				
			</div>
			<div id="<?php echo $form_id; ?>_submitWarn" class="fc-mssg pure-u-1" style="display:none;"><?php echo JText::_('FLEXI_FILTERS_CHANGED_CLICK_TO_SUBMIT'); ?></div>
			<?php endif; ?>
