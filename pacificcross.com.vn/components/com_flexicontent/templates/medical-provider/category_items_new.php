...
<script>
	...
	$("#adminForm_261_val").append($("#adminForm_261_val option").remove().sort(function(a, b) {
		...
		<div class="provider-list-box bkg-white pall-15px bloc<?php echo $item->id; ?>">
            ...
            <div class="pure-g">
                ...
                <div class="pure-u-1 pure-u-sm-1-2 pure-sm-padding-right">
                    <h4>Opening Hours</h4>
                    <p>
                        Monday - Sunday: 07:30 - 12:00, 13:30 - 17:00<br>
                        Emergency: 24/7<br>
...
<div class="mapside sameheight">
    <div style="    float: right;    text-align: right;    position: absolute;    z-index: 100000;    right: 0px;        ">
        <li style="width: 210px; float: left;background-color: #FF5A5F;  padding-top: 5px;    text-align: center; color: #fff ;    opacity: 0.8;    padding-bottom: 5px;">Hospital | Bệnh Viện</li>
        <li style="width: 210px; float: left;background-color: #00a3d9;  padding-top: 5px;    text-align: center; color: #fff ; opacity: 0.8;    padding-bottom: 5px;" >Clinic | Phòng Khám</li>
    </div>
	<!--#HT google map-->
	<div id="mygooglemap"></div>
        
    
<script src="http://maps.googleapis.com/maps/api/js?v=3&sensor=false&key=AIzaSyDM1BwTTwt5nY8RpdiSJwAZTJvK3nfG-sU&callback=initMap"></script>
	...
	function initialize() {
		...
		if (latlong_a.length) {
			...
			for (var i = 0; i < latlong_a.length; i++) {
				...
				if ( latlong_o.am.trim() == 'Fee : High' ){
                                    
                                    var texla = "$$$";
                                    
                                }else if ( latlong_o.am.trim() == 'Fee : Medium' ){ 
                                    var texla = "$$";
                                }else if ( latlong_o.am.trim() == 'Fee : Low' ){ 
                                    var texla = "$";
                                }else { 
