...
<h1 class="page-title"><?php echo $this->params->get('page_heading'); ?></h1>
<?php endif; ?>
...
<div class="pure-g margin-top">
    <div class="pure-u-1">
        <?php if (isset($item->positions['full-width-block'])) : ?>
			<?php foreach ($item->positions['full-width-block'] as $field) : ?>
				<?php echo $field->display; ?>
			<?php endforeach; ?>
		<?php endif; ?>
    </div><!-- end of pure-u-1 -->
...
<div class="pure-g left-right-selector">
	<?php if (isset($item->positions['half-width-block'])) : ?>
		<?php foreach ($item->positions['half-width-block'] as $field) : ?>
			<?php echo $field->display; ?>
		<?php endforeach; ?>
	<?php endif; ?>
</div><!-- end of pure-g -->
