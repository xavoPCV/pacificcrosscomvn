...
<?php if ($this->params->get('show_title', 1)) : ?>
	<h1 class="page-title"><span class="icon-border"><i class="ion ion-help"></i></span> <?php echo $item->title; ?></h1>
<?php endif; ?>
...
<?php if (isset($item->positions['faq-items'])) : ?>
	<?php foreach ($item->positions['faq-items'] as $field) : ?>
		<?php echo $field->display; ?>
	<?php endforeach; ?>
<?php endif; ?>
