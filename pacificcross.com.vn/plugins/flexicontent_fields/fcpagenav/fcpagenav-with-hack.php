...
class plgFlexicontent_fieldsFcpagenav extends JPlugin
{
	...
	function onDisplayFieldValue(&$field, $item, $values=null, $prop='display')
	{
		...
		if ($field->prev)
		{
			...
			$html .= '
				<a href="'. $field->prevurl .'" title="'. $field->prevtitle .'" class="prev-article pure-button button-small pure-button-primary button-inverted">
			...
			$html .= '
				<span class="prev-article pure-button pure-button-disabled button-small pure-button-primary button-inverted">
		...
		if ($field->next)
		{
			...
			$html .= '
				<a href="'. $field->nexturl .'" title="'. $field->nexttitle .'" class="next-article pure-button button-small pure-button-primary button-inverted">
			...
			$html .= '
				<span class="next-article pure-button pure-button-disabled button-small pure-button-primary button-inverted">
